...
function textbox(locals) {
  ...
  return {
    ...
    attrs: {
      ...
      }, _className[config.wide + ' wide'] = !_tcombValidation2['default'].Nil.is(config.wide), _className)
    },
  ...
  return {
    ...
    attrs: {
      className: (_className2 = {
        ...
        error: locals.hasError,
        disabled: locals.disabled
      }, _className2[config.wide + ' wide'] = !_tcombValidation2['default'].Nil.is(config.wide), _className2)
    },
    children: {
      tag: 'div',
      attrs: {
  ...
  return {
    ...
    attrs: {
      className: (_className3 = {
        ...
        error: locals.hasError,
        disabled: locals.disabled
      }, _className3[config.wide + ' wide'] = !_tcombValidation2['default'].Nil.is(config.wide), _className3)
    },
    children: [label, control, help, error]
  };
}
  ...
  return {
    ...
    attrs: {
      className: (_className4 = {
        ...
        error: locals.hasError,
        disabled: locals.disabled
      }, _className4[config.wide + ' wide'] = !_tcombValidation2['default'].Nil.is(config.wide), _className4)
    },
    children: [label, control, help, error]
  };
}
  ...
  return {
    ...
    attrs: {
      className: (_className5 = {
        ...
        error: locals.hasError,
        disabled: locals.disabled
      }, _className5[config.wide + ' wide'] = !_tcombValidation2['default'].Nil.is(config.wide), _className5)
    },
    children: [label, control, help, error]
  };
}
