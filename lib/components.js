...
var ____ClassE=React.Component;for(var ____ClassE____Key in ____ClassE){if(____ClassE.hasOwnProperty(____ClassE____Key)){Component[____ClassE____Key]=____ClassE[____ClassE____Key];}}var ____SuperProtoOf____ClassE=____ClassE===null?null:____ClassE.prototype;Component.prototype=Object.create(____SuperProtoOf____ClassE);Component.prototype.constructor=Component;Component.__superConstructor__=____ClassE;
...
function Form(){}
  ...
  Object.defineProperty(Form.prototype,"getComponent",{writable:true,configurable:true,value:function(path) {
    path = t.Str.is(path) ? path.split('.') : path;
    return path.reduce(function(input, name)  {return input.refs[name];}, this.refs.input);
  }});
